...
public class EmployeesDao {
   //Instanciar conexion BD
    ...
    public boolean registerEmployeeQuery(Employees employee){
        String query = "INSERT INTO employees(id,full_name,user_name,address,"
    ...
    public List listEmployeesQuery(String value){
        ...
        try{
            ...
            if(value.equalsIgnoreCase("")){
                ...
                pst=conn.prepareCall(query_search_employee);
                rs= pst.executeQuery();  
            }
            while(rs.next()){
                Employees employee = new Employees();
    ...
    public boolean updateEmployeeQuery(Employees employee){
        String query = "UPDATE employees SET full_name=?, user_name=?,"
    ...
    public boolean deleteEmployeeQuery(int id){
        ...
        try{
            ...
            JOptionPane.showMessageDialog(null,"No se puede eliminar un empleado que tenga relación "
                    +"con otra tabla"+e);
            return false;
        }
    }
